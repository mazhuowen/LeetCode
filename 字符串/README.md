...
* $\clubs$困难[#132 Palindrome Partitioning II](./#132 Palindrome Partitioning II.md)    曼彻斯特及动态规划检测回文串的最小划分
...
* 简单[#929 Unique Email Addresses](./#929 Unique Email Addresses.md)    遍历判断
* 中等[#1016 Binary String With Substrings Representing 1 To N](./#1016 Binary String With Substrings Representing 1 To N.md)    暴力匹配
...
* 中等[#388 Longest Absolute File Path](./#388 Longest Absolute File Path.md)    最长文件路径
* 中等[#393 UTF-8 Validation](./#393 UTF-8 Validation.md)    位操作校验编码字符
* 简单[#409 Longest Palindrome](./#409 Longest Palindrome.md)    字符统计
