...
执行用时：312ms，在所有java提交中击败了78.05%的用户。

内存消耗：57.8MB，在所有java提交中击败了100.00%的用户。

## 官方解题

&emsp;暂无，密切关注。社区中的方法形式不同，但共通的一点是保存每个数字出现的索引，使用二分查找来统计。至于线段树，则利用区间规则，表明哪些数需要统计，哪些无需统计，大大减小了统计范围。
