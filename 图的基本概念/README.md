...
* 困难[#864 Shortest Path to Get All Keys](./#864 Shortest Path to Get All Keys.md)    广度优先搜索记录最短步数
...
* $\clubs$中等[#1654 Minimum Jumps to Reach Home](./#1654 Minimum Jumps to Reach Home.md)    广度优先搜索求解最短步骤
* 困难[#LCP09 最小跳跃次数](./#LCP09 最小跳跃次数.md)    广度优先搜索求解最短步骤
...
* $\clubs$困难[#1591 Strange Printer II](./#1591 Strange Printer II.md)    抽象为图的拓扑排序
